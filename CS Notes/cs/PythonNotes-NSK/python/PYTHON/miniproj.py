...
w0={0:['linguist','noun,refers a person who can survive in many countries'],
 1:['joey','noun,animals,found only in southernmost island'],
	2:['zebra','noun,animals,hybrid of many animals'],
	3:['yalk','noun,animals,sounds similar to a yellow edible item'],
	4:['frown','noun,expression when you dont like something'],
	5:['cripple','verb,disability,'],
	6:['drip','noun,object that is needed for survival'],
	7:['rampage','verb,related with action of group of people'],
	8:['wrath','noun,feeling'],
	9:['queer','adjective,different(synonym)'],
	10:['unique','adjective,abnormal, strange, thinks out of the box'],
	11:['pope','noun,religion,head of a community'],
	12:['missile','noun,science,ex-president of india(known as)'],
	13:['nibble','noun,computer,electronics'],
	14:['gamble','verb,game,only rich people are involved'],
	15:['asylum','noun,health institution'],
	16:['success','noun,outcome,everyone wishes for it'],
	17:['erratic','adjective,unpredictive'],
	18:['trek','noun,activity, something done for time pass and exercise'],
	20:['vicious','adjective,behaviour'],
	21:['brother','noun,relation'],
	22:['horrified','verb,feeling,conjuring'],
 19:['informer','noun,person of help'],
	23:['killer','noun,person related to cop'],
	24:['organic','noun,science with full of drawing ,food'],
	25:['xenon','noun,science(element),fluroscent'],
	26:['obnoxious','adjective,unpleasant'],
	27:['misbehave','verb,unpleasant act,teachers hate this act of students'],28:['anthropology','noun,study of culture'],
	29:['jurassic','adjective,mesozoic era,hollywood'],
	30:['dynamic','adjective,constant progress,computer language'],
	31:['scorpion','noun,animal,zodiac sign'],
	32:['troubleshoot','verb,analysis,computers'],
	33:['prosper','verb,act of growing'],
	34:['narcotic','noun/verb,related to olden latin america']}
...
# asking the user to input the level of the game
...
# to stop the user from entering the letters , as max chances are over and the guessed word not same as given word
		if j==0 and (w1!=w2):
			...
			z=name.upper()
			print('-------------------------------------')
			print('**** WELL TRIED', z ,'YOU HAVE LOST *****')
			print('********* GAME  OVER **********')
			print('-------------------------------------')
			print()
			print('ACTUAL  WORD  : ',w)
