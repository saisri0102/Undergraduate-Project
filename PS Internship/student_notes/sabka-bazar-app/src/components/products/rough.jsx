...
import ProductsList from './ProductsList-rough'
    ...
    return (
        ...
        <aside className="navbar-expand-md bg-light-gray  col-12 my-2 col-md-2 ">
            ...
            <ul className="d-felx flex-column nav-item collapse navbar-collapse ">
                ...
                <NavLink to='/fruits'>Fruits and Vegetables</NavLink>
                </li>
                <li className ="pb-3 b-bottom">
                <NavLink to="/bakery">Bakery Items and Dairy</NavLink>
                </li>
                <li className ="pb-3 b-bottom">
                <NavLink to="/beverages">Beverages</NavLink>
                </li>
                <li className ="pb-3 b-bottom">
                <NavLink to="/beauty">Beauty and Hygine</NavLink>
                </li>
                <li className ="pb-3 b-bottom">
                <NavLink to="/babycare">Baby Care</NavLink>
                </li>
            </ul>
...
function Products(props) {
    ...
    return (
        <div className="row container">
            ...
            {/* <ProductsList productsState = {productsState} props = {props} /> */}
        
            {/* <Route path = {this.props.match.url} */}
            <Route path ={props.match.url + 'fruits'}  component={(props)=> <ProductsList productsState = {productsState} />} />
