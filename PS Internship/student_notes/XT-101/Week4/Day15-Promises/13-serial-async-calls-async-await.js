// async - these functions can be paused and resumed
// it makes async code to look like synchronus code
// it gets paused when you await on a promise
// gets resumed when control goes back to the caller of the async function 
